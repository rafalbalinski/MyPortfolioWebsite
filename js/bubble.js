class Bubble {
    constructor(bubble, dx, dy) {
        ...
        this.dy = dy;
        this.bubble = bubble;
        this.XPosition = titlePage.offsetWidth/2;
        this.YPosition = titlePage.offsetHeight/2;
    ...
    print() {
        console.log(`góra ${this.bubble.offsetTop}`);
        console.log(`dół ${this.bubble.offsetTop + this.bubble.offsetHeight}`);
        console.log(`lewy ${this.bubble.offsetLeft}`);
        console.log(`prawy ${this.bubble.offsetLeft + this.bubble.offsetWidth}`);
    }
}
