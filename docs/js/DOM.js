...
const navVerticalItems = nav.querySelectorAll('.nav__vertical-item');                               // vertical navigation buttons
const navHorizontalItems = nav.querySelectorAll('.nav__horizontal-item');                           // horizontal navigation buttons
